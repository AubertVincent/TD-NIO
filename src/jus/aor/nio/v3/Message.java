...
public class Message implements Serializable {
	 ...
	 * ayant qui ont été nécessaires à son acquisition. La date est ajustée au
	 * moment de cette création et la data associée est augmentée de de la
	 * représentation de ce message (progression arithmétique de 43).
	 * 
	 * @param marshalled
